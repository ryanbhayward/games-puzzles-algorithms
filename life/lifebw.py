...
execution: python3 lifebw.py filename pause ticks
  e.g. python3 lifebw.py t/glider .1 30

this program lifebw.py created Sep 2022: 
  paint.py embedded back into this program, with no coloring
  (makes it simpler to run, e.g. on windows machines)
"""
...
'''
previously: paint text characters
now       : just leave text characters as they are, don't color them
'''
