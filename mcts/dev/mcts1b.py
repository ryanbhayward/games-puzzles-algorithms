...
# mcts1b: can we improve move ordering?
...
class Mcts1(Mcts0):
    ...
    def best_uct(self, node: TreeNode1) -> TreeNode1:
        ...
        #kids = []
        #for child in node.children: kids.append(child.move)
        #for move in (7,8,9,10,13,14,15,16,19,20,21,22,25,26,27,28):
        #for move in (15,20,10,25,14,21,9,16,19,26,8,22,13,27,7,28):
        #    if move in kids:
        #        child = node.children[kids.index(move)]
